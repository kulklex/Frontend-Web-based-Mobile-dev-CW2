...
const app = Vue.createApp({
    ...
    methods: {
        async fetchLessons() {
            try {
                const response = await fetch('//courseworkvuejs-env.eba-igkjeup4.eu-west-2.elasticbeanstalk.com/lessons');
                if (!response.ok) {
        ...
        async updateLessonSpaces(lessonId, newSpaces) {
            try {
                const response = await fetch(`//courseworkvuejs-env.eba-igkjeup4.eu-west-2.elasticbeanstalk.com/lessons/${lessonId}`, {
                    method: 'PUT',
        ...
        async createOrder() {
            try {
                ...
                const response = await fetch('//courseworkvuejs-env.eba-igkjeup4.eu-west-2.elasticbeanstalk.com/orders', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        async searchLessons() {
            try {
                ...
                const response = await fetch(`//courseworkvuejs-env.eba-igkjeup4.eu-west-2.elasticbeanstalk.com/lessons/search?filter=${this.searchInput}`);
                this.lessons = await response.json();
            } catch (error) {
                console.error(error);
            }
